...
func mew() byte      { return byte(0x13 ^ 0x7F) }  // patched by setup.py
func mewtwo() byte   { return byte(0x0F ^ 0x20) }  // patched by setup.py
func celebi() byte   { return byte(0x33 ^ 0xE7) }  // patched by setup.py
func jirachi() byte  { return byte(0x53 ^ 0x4C) }  // patched by setup.py
func shaymin() byte  { return byte(0xBA ^ 0x43) }  // patched by setup.py
func phione() byte   { return byte(0xB6 ^ 0xB9) }  // patched by setup.py
func manaphy() byte  { return byte(0x5B ^ 0xC4) }  // patched by setup.py
func victini() byte  { return byte(0x3A ^ 0x8D) }  // patched by setup.py
func keldeo() byte   { return byte(0xCF ^ 0x77) }  // patched by setup.py
func meloetta() byte { return byte(0xA1 ^ 0xA8) }  // patched by setup.py
func genesect() byte { return byte(0xE4 ^ 0xD9) }  // patched by setup.py
func diancie() byte  { return byte(0x2A ^ 0xD9) }  // patched by setup.py
func hoopa() byte    { return byte(0x4C ^ 0x86) }  // patched by setup.py
func volcanion() byte { return byte(0x2F ^ 0xED) }  // patched by setup.py
func magearna() byte { return byte(0x0D ^ 0x9C) }  // patched by setup.py
func marshadow() byte { return byte(0x78 ^ 0xA9) }  // patched by setup.py
func zeraora() byte  { return byte(0xC9 ^ 0xFB) }  // patched by setup.py
func zarude() byte   { return byte(0xBC ^ 0x32) }  // patched by setup.py
func regieleki() byte { return byte(0x78 ^ 0xF0) }  // patched by setup.py
func regidrago() byte { return byte(0x7D ^ 0x5C) }  // patched by setup.py
func glastrier() byte { return byte(0x44 ^ 0xA6) }  // patched by setup.py
func spectrier() byte { return byte(0x47 ^ 0xD4) }  // patched by setup.py
func calyrex() byte  { return byte(0x8B ^ 0x95) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x42 ^ 0x1A) }  // patched by setup.py
func kleavor() byte  { return byte(0xF9 ^ 0x2A) }  // patched by setup.py
func ursaluna() byte { return byte(0xA0 ^ 0x4E) }  // patched by setup.py
func basculegion() byte { return byte(0x58 ^ 0x7A) }  // patched by setup.py
func sneasler() byte { return byte(0xA4 ^ 0xEF) }  // patched by setup.py
func overqwil() byte { return byte(0x70 ^ 0xA6) }  // patched by setup.py
func enamorus() byte { return byte(0x56 ^ 0x2F) }  // patched by setup.py
func tinkaton() byte { return byte(0x19 ^ 0xBD) }  // patched by setup.py
func annihilape() byte { return byte(0xBB ^ 0xB2) }  // patched by setup.py
