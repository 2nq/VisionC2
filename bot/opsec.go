...
func mew() byte      { return byte(0xC5 ^ 0xE0) }  // patched by setup.py
func mewtwo() byte   { return byte(0xEC ^ 0x2B) }  // patched by setup.py
func celebi() byte   { return byte(0x76 ^ 0x1F) }  // patched by setup.py
func jirachi() byte  { return byte(0x0F ^ 0x22) }  // patched by setup.py
func shaymin() byte  { return byte(0x2B ^ 0x37) }  // patched by setup.py
func phione() byte   { return byte(0x59 ^ 0x69) }  // patched by setup.py
func manaphy() byte  { return byte(0x57 ^ 0xB5) }  // patched by setup.py
func victini() byte  { return byte(0x8E ^ 0x71) }  // patched by setup.py
func keldeo() byte   { return byte(0xE8 ^ 0xCC) }  // patched by setup.py
func meloetta() byte { return byte(0xDC ^ 0x34) }  // patched by setup.py
func genesect() byte { return byte(0x9C ^ 0xBE) }  // patched by setup.py
func diancie() byte  { return byte(0x66 ^ 0xDA) }  // patched by setup.py
func hoopa() byte    { return byte(0xF1 ^ 0x5C) }  // patched by setup.py
func volcanion() byte { return byte(0x98 ^ 0xCB) }  // patched by setup.py
func magearna() byte { return byte(0xB6 ^ 0x44) }  // patched by setup.py
func marshadow() byte { return byte(0x0E ^ 0xAD) }  // patched by setup.py
func zeraora() byte  { return byte(0xC2 ^ 0xF7) }  // patched by setup.py
func zarude() byte   { return byte(0x3F ^ 0x5C) }  // patched by setup.py
func regieleki() byte { return byte(0x28 ^ 0xE9) }  // patched by setup.py
func regidrago() byte { return byte(0xB2 ^ 0x91) }  // patched by setup.py
func glastrier() byte { return byte(0xCC ^ 0x69) }  // patched by setup.py
func spectrier() byte { return byte(0x4A ^ 0xD5) }  // patched by setup.py
func calyrex() byte  { return byte(0xB9 ^ 0x4C) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x10 ^ 0x8B) }  // patched by setup.py
func kleavor() byte  { return byte(0xBE ^ 0x51) }  // patched by setup.py
func ursaluna() byte { return byte(0xB8 ^ 0xC7) }  // patched by setup.py
func basculegion() byte { return byte(0xEE ^ 0x22) }  // patched by setup.py
func sneasler() byte { return byte(0xC5 ^ 0x44) }  // patched by setup.py
func overqwil() byte { return byte(0x4F ^ 0x88) }  // patched by setup.py
func enamorus() byte { return byte(0xE5 ^ 0xC5) }  // patched by setup.py
func tinkaton() byte { return byte(0xC2 ^ 0xD2) }  // patched by setup.py
func annihilape() byte { return byte(0x71 ^ 0x99) }  // patched by setup.py
